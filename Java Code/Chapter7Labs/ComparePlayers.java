...
public class ComparePlayers   {
     public static void main(String[] args)  {
          ...
          System.out.println("Input information for player 1: ");
          player1.readPlayer();

          //Prompt for and read in information for player 2
          System.out.println("Input information for player 2: ");
          player2.readPlayer();

          //Compare player1 to player 2 and print a message saying
          //whether they are equal
          if (player1.equals(player2) == 1) System.out.println("They're equal!");
